...
public class FuseInvalidUsageHandler implements InvalidUsageHandler<CommandSender> {
    ...
    public void handle(Invocation<CommandSender> invocation, InvalidUsage<CommandSender> result,
        ...
        if (schematic.isOnlyFirst()) {
            sender.sendMessage(
                    MINI_MESSAGE.deserialize("<red>Incorrect usage of command<gray> - " + schematic.first()));
            return;
        }
